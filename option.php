                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="breadcrumb-text">
                                        ...
                                        <a href="admin/client" class="btn btn-primary btn-lg mt-2">Louer Maison</a>
                                        <a href="admin/bailleur" class="btn btn-info btn-lg mt-2">Faire Louer Maison</a>
                                        <a href="admin/" class="btn btn btn-dark btn-lg mt-2">Se Connecter</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
